...
<div class="new-post">
    <div class="container">
        ...
        ?>
        <h3>Add Company photos</h3>
        <form method="post" action="<?php echo base_url()?>admin/product/add_company_photo/add" enctype="multipart/form-data">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <?php echo form_open(base_url('admin/product/add_company_photo/deletecontactdetail'), array('method' => 'post')); ?>
