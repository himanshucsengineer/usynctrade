...
<div class="new-post">
    <div class="container">
        ...
        ?>
        <h3>Add Product</h3>
        <form method="post" action="<?php echo base_url()?>admin/product/category/create_cate" enctype="multipart/form-data">

            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <label>Category Name</label>
                        <input type="text" placeholder="enter category name" name="cate_name">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <?php echo form_open(base_url('admin/product/category/deletecontactdetail'), array('method' => 'post')); ?>
