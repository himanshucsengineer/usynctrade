...
class Edit extends CI_controller
{
  ...
  {
    $data['fetch_content']=$this->productmodel->fetch_product();
  ...
  public function update_product()
  {
      ...
      $this->form_validation->set_rules('id', 'shipment_port', 'required');
      if ($this->form_validation->run()) {
        ...
        $data=$this->productmodel->fetch_product();
        ...
        foreach ($data as $value) {
            if ($value['id'] == $this->input->post('id')) {
              ...
              if ($this->productmodel->update_product($data,$id)) {
                  ...
                  $this->session->set_flashdata('success', 'Product Updated Successfully Submited');
